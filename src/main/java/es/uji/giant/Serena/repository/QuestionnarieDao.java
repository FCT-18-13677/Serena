package es.uji.giant.Serena.repository;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.google.gson.Gson;
import es.uji.giant.Serena.config.ElasticSearchConfiguration;
...
public class QuestionnarieDao {
    ...
    public static void insertQuestionnarie(String id, Questionnarie questionnarie) {
    ...
    public static List<Questionnarie> getAllQuestionnaries() {
        Gson gson = new Gson();
